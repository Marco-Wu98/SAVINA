...
<head>
    ...
    <link rel="stylesheet" href="static/css/book/orders.css">
...
<div class="main">
    ...
    <c:if test="${requestScope.allOption == true}">
        <c:set var="displayOrders" value="${sessionScope.orders}"/>
    </c:if>
    ...
    <div class="wrapper container-fluid">
        <div class="orders container">
            ...
            <div class="options row"></span>
                <a href="orders" class="col-2 <c:if test="${requestScope.allOption == true}">active</c:if>">
                    <span>${sessionScope.orders.size()}</span>
                    <span>Tất cả</span>
                </a>
                <a href="pendingOrders" class="col-2 <c:if test="${requestScope.pendingOption == true}">active</c:if>">
                ...
                <a href="cancelOrders" class="col-2 <c:if test="${requestScope.cancelOption == true}">active</c:if>">
                       ...
                       <c:if test="${order.status.equalsIgnoreCase('CANCEL')}">Bị hủy</c:if>
                        ...
                        <div class="order-footer">
                            ...
                            <div>
                                ...
                                <div class="button">
                                    <a href="cancelOrder?orderNo=${order.orderNo}" onclick="return confirmCancel()"
                                       class="btn btn-danger <c:if test="${order.status.equalsIgnoreCase('cancel')}">disabled</c:if> ">Hủy
                                        đơn</a>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    const toOrderInfo = function (element) {
        const orderNo = element.getAttribute('data-orderNo');
        window.location = "orderInfo?orderNo=" + orderNo;
    }
</script>
